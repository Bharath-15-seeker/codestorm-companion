          ...
          <div className="text-primary-foreground">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Stat
                ...
                label="Solved"
                value={
                  (codingProgress?.solvedQuestions ?? 0) +
                  (aptitudeProgress?.solvedQuestions ?? 0)
                }
              />
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 -mt-6">
        ...
        <motion.div variants={itemVariants} className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          <ProgressCard
            ...
            icon={Code}
            solved={codingProgress?.solvedQuestions ?? 0}
            total={codingProgress?.totalQuestions ?? 1}
          ...
          <ProgressCard
            ...
            icon={Brain}
            solved={aptitudeProgress?.solvedQuestions ?? 0}
            total={aptitudeProgress?.totalQuestions ?? 1}
